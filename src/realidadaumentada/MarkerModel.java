...
{
  private final String MARKER_DIR = "C:/Users/Administrador/Documents/RealidadAumentada/src/Data/";
  ...
  static PropManager propMan=null;

  private int numTimesLost = 0;   // number of times marker for this model not detected



  public MarkerModel(String markerFnm, String modelFnm, double scale, boolean hasCoords)
  { 
    markerName = markerFnm;
    modelName = modelFnm.substring(0, modelFnm.lastIndexOf('.'));   // remove filename extension
  ...
  {
    propMan = new PropManager(modelFnm, hasCoords);  
