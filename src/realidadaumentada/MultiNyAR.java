...
{
  private final String PARAMS_FNM = "C:/Users/Administrador/Documents/RealidadAumentada/src/Data/camera_para.dat";
  ...
  */
  { 
    ...
    MarkerModel mm1 = new MarkerModel("patt.hiro", "robot.3ds", 0.15, false);//flarlogo.patt", "robot.3ds,0.10"
   // MarkerModel mm1=new MarkerModel("patt.hiro","Chair Nimrod Magis Furniture N010613.3ds",0.15,false);
   // MarkerModel mm1=new MarkerModel("patt.hiro","Leopard animal N090311.3DS",0.10,false);
    ...
    MarkerModel mm2 = new MarkerModel("patt.kanji", "cow.obj", 0.12, false);//2.patt", "T_REX.3DS,0.15"
