...
public class PropManager
{
  ...
  { 
	...
	try {
      if (ext.equals("obj")) {   // the file is a wavefront model
        ...
        s = of.load("C:/Users/Administrador/Documents/RealidadAumentada/src/models/"+fnm);
      }
      else {  // use Portfolio loader for other models
        ModelLoader modelLoader = new ModelLoader();
	    s = modelLoader.load("C:/Users/Administrador/Documents/RealidadAumentada/src/models/"+fnm);   // handles many types of file
      }
    }
	catch (Exception e) {
    ...
    moveTG.setCapability(TransformGroup.ALLOW_COLLISION_BOUNDS_READ);
    moveTG.setCapability(TransformGroup.ALLOW_COLLISION_BOUNDS_WRITE);
    moveTG.setCapability(TransformGroup.ALLOW_AUTO_COMPUTE_BOUNDS_READ);
    moveTG.setCapability(TransformGroup.ALLOW_AUTO_COMPUTE_BOUNDS_WRITE);
    moveTG.setCapability(TransformGroup.ALLOW_COLLIDABLE_READ);
    moveTG.setCapability(TransformGroup.ALLOW_COLLIDABLE_WRITE);
    moveTG.setCapability(TransformGroup.ENABLE_COLLISION_REPORTING);
  ...
  */
  { 
    String coordFile = "C:/Users/Administrador/Documents/RealidadAumentada/src/models/" + getName(fnm) + "Coords.txt";
    try {
  ...
  */
  ...
  {
    String coordFnm = "C:/Users/Administrador/Documents/RealidadAumentada/src/models/" + getName(filename) + "Coords.txt";
    try {
